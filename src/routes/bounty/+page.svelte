...
<p class="pt-2">Bounty was deployed <a href={'https://whatsonchain.com/tx/' + form?.tx}>Transaction Link</a></p>
  {/if}
</div>
...
>
  ...
  {#if form?.success}
    <!-- this message is ephemeral; it exists because the page was rendered in
		   response to a form submission. it will vanish if the user reloads -->
<p class="pt-2">Bounty was unlocked deployed <a href={'https://whatsonchain.com/tx/' + form?.tx}>Transaction Link</a></p>
  {/if}
</div>